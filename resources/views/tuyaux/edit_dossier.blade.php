...
@section('title')
<title> CB Ingé - Editer dossier</title>
@endsection
...
<form method="POST" action="/file/update_dossier/{{$dossier->id}}" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <input id="titre" type="text" class="form-control form-content @error('titre') is-invalid @enderror" name="titre" value="{{$dossier->titre}}" required placeholder="Titre">
