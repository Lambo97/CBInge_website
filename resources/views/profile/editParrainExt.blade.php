...
@section('content')
        ...
        <h2 class="mb-4"><strong>Liste des parrains baptisés à l'extérieur de {{Auth::user()->surnom_forum}}</strong></h2>
                ...
                <table class="table table-dark">
                    ...
                    @forelse ($parrains as $parrain)
                        <tr>
                            ...
                            <td class="text-center">{{ $parrain->nom }}</td>
                            <td class="text-center">{{ $parrain->annee }}</td>
                            <td><a href="{{ '/profile/removeParrainExt/'.$parrain->id }}"
            ...
            <h3>Ajouter des parrains baptisés à l'extérieurs:</h3>
            <form method="POST" action="/profile/addParrainExt/{{Auth::user()->id}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <select id="faculte" class="form-control form-content @error('section') is-invalid @enderror" name="faculte">
                        ...
                        <option value="en Médecine">Faculté de médecine</option>
