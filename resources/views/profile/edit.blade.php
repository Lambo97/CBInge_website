...
<form method="POST" action="/profile/update/{{$user->id}}" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <label for="section" class="d-none col-md-4 col-form-label text-md-right">Section</label>
            
        <select id="section" type="text" class="form-control form-content @error('section') is-invalid @enderror" name="section" value="{{ old('section') ?? $user->section}}" autocomplete="section">
