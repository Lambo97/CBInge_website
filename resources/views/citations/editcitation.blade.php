...
@section('content')
<h1 class="mb-5">Citations - Editer citation</h1>

<div class="row">
    <div class="col-12">
    <form method="POST" action="/citations/update/{{$post->id}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row mb-0">
          ...
          <!--  <div class="col-md-2">
            ...
            <div class="col-md-2">
                    <a href="/citations"><button type="button" class="buttons-green font-weight-bold">
                        Retour
                </button></a>
            </div>
        </div>
