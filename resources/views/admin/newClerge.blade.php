...
@section('title')
<title> CB Ingé - Nouveau clergé </title>
@endsection

@section('content')
<div class="row mb-4">
    <div class="col-md-6 col-sm-12">
        <h1 class="mb-3">Nouveau clergé</h1>
    </div>
    @if(Auth::check() and Auth::user()->droit == 1)
    <div class="col-md-6 d-flex justify-content-end align-items-center">
        <a class="buttons-green font-weight-bold" href="/delations">Retour</a>
    </div>
    @endif
</div>

<form method="POST" action="/admin/repertoire/nouveauClerge" enctype="multipart/form-data">
    @csrf
