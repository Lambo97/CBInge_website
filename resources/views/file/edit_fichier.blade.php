...
@section('title')
<title> CB Ingé - Editer fichier</title>
@endsection
...
<form method="POST" action="/file/update_fichier/{{$fichier->id}}" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <input id="titre" type="text" class="form-control form-content @error('titre') is-invalid @enderror" name="titre" value="{{$fichier->titre}}" required placeholder="Titre">
    ...
    <textarea id="commentaire" type="text" class="form-control form-content @error('commentaire') is-invalid @enderror" name="commentaire" value="{{ old('commentaire')}}" placeholder="Commentaires">{{$fichier->commentaire}}</textarea>
