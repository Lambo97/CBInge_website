...
@section('title')
<title> CB Ingé - Anciens PV Répet Chants </title>
@endsection

@section('content')
<div class="row mb-3">
    <div class="col-md-4 col-sm-12">
        <h1>Anciens PV Répet Chants</h1>
    </div>
    <div class="col-md-8 d-flex justify-content-end align-items-center">
        <a class="buttons-blue font-weight-bold" href="/bleus/pvrepetchant/add">Ajouter un Pv</a>
    </div>
</div>
    ...
    <div class="well px-3 py-3 my-3 border border-light rounded ">
        <div class="row mb-2">
            <div class="col-md-6 col-sm-12">
                <h3><a class="blue-link" href="/bleus/pvrepetchant/show/{{$pv->id}}">{{$pv->titre}}</a></h3>
            </div>
            @if(Auth::user()->id == $pv->id_auteur || Auth::user()->droit < 3)
            <div class="col-md-1 col-xs-2 d-flex justify-content-end">
                <a href="#" class="blue-link mr-2"><i class="far fa-trash-alt" data-toggle="modal" data-target="#delete{{$pv->id}}"></i></a>
