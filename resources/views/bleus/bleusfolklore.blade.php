...
@section('content')
<script src="{{ asset('/js/bleus/bleusfolklore.js') }}" defer></script>
...
<div class="nav_welcome_action d-flex font-size">
            ...
            <p class="w-50 pb-2 mt-5 text-center font-weight-bold" id="13">
                 A Fond
            </p>
            <p class="w-50 pb-2 mt-5 text-center font-weight-bold" id="14">
                Chants
            </p>
</div>
<div id="penne">
...
<p style="text-align:center; background-color:#0F4BED; padding-top:2px; padding-bottom:2px; margin-bottom:10px"> Le chant ingé </p>
<div>
