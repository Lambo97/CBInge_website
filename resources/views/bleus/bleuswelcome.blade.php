...
<script src="{{ asset('/js/welcome.js') }}" defer></script>
    ...
    <p>Dans les sections <a class="green-link" href="#"> Informations</a> et <a class="green-link" href="#">Folklore</a> se trouve une excellente description du baptême.</p>
